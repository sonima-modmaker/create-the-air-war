	...
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if ((new Object() {
			...
			if (world instanceof ServerLevel projectileLevel) {
				...
				_entityToSpawn.shoot(launch.direction().x, launch.direction().y, launch.direction().z, 3, 0);
				...
				////RecoilForceAttachment.addRecoil(world, BlockPos.containing(x, y, z), 0, 0, -50);
			}
			{
		...
		if ((new Object() {
			...
			if (world instanceof ServerLevel projectileLevel) {
				...
				ProjectileLaunchHelper.applyInheritedVelocity(_entityToSpawn, launch.inheritedVelocity());
				if (world instanceof net.minecraft.world.level.Level _level) _level.addFreshEntity(_entityToSpawn);
				////RecoilForceAttachment.addRecoil(world, BlockPos.containing(x, y, z), -50, 0, 0);
			}
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = Blocks.AIR.defaultBlockState();
