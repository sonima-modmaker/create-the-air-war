...
public class M24bultEntity extends AbstractArrow implements ItemSupplier, RocketExplosionCarrier {
	@Override
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		M24bultKoghdaSnariadPopadaietVBlokProcedure.execute(this.level(), blockHitResult.getLocation().x, blockHitResult.getLocation().y, blockHitResult.getLocation().z, this);
	...
	public ExplosionUtils.ProjectileExplosionProfile getExplosionProfile() {
		return new ExplosionUtils.ProjectileExplosionProfile(
			...
			CreateTheAirWarsModParticleTypes.EXLOSION.get(), 6, 1.5, 1.5, 1.5, 0.4, 0, false
		);
	}
}
