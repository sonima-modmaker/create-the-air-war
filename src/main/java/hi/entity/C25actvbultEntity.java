...
public class C25actvbultEntity extends AbstractArrow implements ItemSupplier, RocketExplosionCarrier {
	@Override
	...
	public ExplosionUtils.ProjectileExplosionProfile getExplosionProfile() {
		return new ExplosionUtils.ProjectileExplosionProfile(
			...
			CreateTheAirWarsModParticleTypes.EXLOSION.get(), 6, 1.5, 1.5, 1.5, 0.4, 6, false
		);
	}
}
